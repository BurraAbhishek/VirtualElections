...
<html>
    ...
    <body>
        ...
        <div id="mainbody" class="mainbody">
            ...
            <h1>
                Are you really sure that you want to vote for the following
            ...
            <form action="../controllers/cast_vote.php" method="post">
                ...
                <br />
                <?php
                    echo '<input type="password" class="nodisplay" ';
                    echo 'name="token" id="token" value="';
                    echo $token;
                    echo '">'; 
                ?>
                <br />
            ...
            <script>
                document.getElementById("myinput").value =
                    sessionStorage.getItem("voted");
            </script>
            <center>
                <button
                    class="submitbtn"
                    onclick="javascript:window.location.href='election.php';"
                    style="width: 80%"
                >
                    NO, GO BACK
                </button>
