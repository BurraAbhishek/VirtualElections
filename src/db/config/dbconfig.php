<?php
	 ...
	 * 		<li> $host: Refers to the URL of the webserver. (Values: localhost, IPv4 addresses) </li>
	 ...
	 * NOTE:
	 * <ul>
	 * 		<li> If you are using object-oriented mysqli instead of PDO, replace PDO with mysqli. </li>
